...
Latest udate: Mon Oct 30 21:17:00 2017
...
|:---------------------------|:---------------------------------------------|:-----------------------|
|RforProteomics              |Bioconductor 1.14.0 (release) 1.15.0 (devel)  |1.15.2                  |
|mzR                         |Bioconductor 2.10.0 (release) 2.11.11 (devel) |2.11.12                 |
|MSnbase                     |Bioconductor 2.2.0 (release) 2.3.14 (devel)   |2.3.15                  |
|pRoloc                      |Bioconductor 1.16.1 (release) 1.17.8 (devel)  |1.17.8                  |
|pRolocGUI                   |Bioconductor 1.10.0 (release) 1.11.2 (devel)  |1.11.3                  |
|pRolocdata                  |Bioconductor 1.14.0 (release) 1.15.0 (devel)  |1.13.3                  |
|rols                        |Bioconductor 2.4.0 (release) 2.5.6 (devel)    |2.5.6                   |
|rpx                         |Bioconductor 1.12.3 (release) 1.13.4 (devel)  |1.13.5                  |
...
|qcmetrics                   |Bioconductor 1.14.0 (release) 1.15.2 (devel)  |1.15.2                  |
...
|ProtGenerics                |Bioconductor 1.8.0 (release) 1.9.1 (devel)    |1.9.1                   |
