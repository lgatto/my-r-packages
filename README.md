...
Latest udate: Thu Mar 15 22:29:24 2018
...
|:---------------------------|:--------------------------------------------|:-----------------------|
|RforProteomics              |Bioconductor 1.15.0 (release) 1.17.1 (devel) |1.17.1                  |
|mzR                         |Bioconductor 2.12.0 (release) 2.13.5 (devel) |2.13.6                  |
|MSnbase                     |Bioconductor 2.4.2 (release) 2.5.8 (devel)   |2.5.10                  |
|pRoloc                      |Bioconductor 1.18.0 (release) 1.19.3 (devel) |1.19.3                  |
|pRolocGUI                   |Bioconductor 1.12.0 (release) 1.13.0 (devel) |1.11.3                  |
|pRolocdata                  |Bioconductor 1.16.0 (release) 1.17.0 (devel) |1.17.1                  |
|rols                        |Bioconductor 2.6.1 (release) 2.7.2 (devel)   |2.7.2                   |
|rpx                         |Bioconductor 1.14.0 (release) 1.15.0 (devel) |1.13.5                  |
|hpar                        |Bioconductor 1.20.0 (release) 1.21.1 (devel) |1.21.1                  |
|Pbase                       |Bioconductor 0.18.0 (release) 0.19.1 (devel) |0.15.3                  |
|ProteomicsAnnotationHubData |Bioconductor 1.8.0 (release) 1.9.0 (devel)   |1.3.3                   |
|qcmetrics                   |Bioconductor 1.16.0 (release) 1.17.1 (devel) |1.17.1                  |
|synapter                    |Bioconductor 2.2.0 (release) 2.3.1 (devel)   |2.3.2                   |
